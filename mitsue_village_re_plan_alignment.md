...
> **Translation note.** The village's English machine translation (in the repository) is heavily garbled — the village name appears as "Mitsu / Otsuke / Gose / Mikawa / Gozumura," all of which are 御杖村 (Mitsue-mura, Uda-gun, Nara). A clean English translation of the key pages is at `Docs extra/mitsue_files from Village hall/mitsue_village_re_plan_clean_translation_en.md`.
...
| **Local production for local consumption** of renewable energy unique to the village's geography | A locally owned generation + consumption system (CHP + solar) feeding a local offtaker | Key Initiative 1 |
...
- 御杖村再エネ導入最大化計画（概要版）, Mitsue Village, Jan 2025 — `Docs extra/mitsue_files from Village hall/20250130saienekeikakugaiyou_translated_eng-1.pdf`
...
- MoE — 地域脱炭素移行・再エネ推進交付金 実施要領（補助率 2/3・3/4 条件）: https://www.env.go.jp/content/900470616.pdf

---

*Prepared by Rob Oudendijk — Mitsue Project · June 7, 2026*
