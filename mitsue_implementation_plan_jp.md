...
   
これらの数値は日本の農村部の現実を踏まえた控えめな見積もりですが、太陽光・バイオマス発電・EV充電設備、蓄電池（フィージビリティスタディで判断）、光ファイバーの利用可能性、建物の状態によって実費は大きく変動いたします。  
   
**第0段階 ― 準備期(1〜3か月目)**  
...
- 系統連系およびFIT/FIP適格性  
- **バイオマス発電の規模検討** ― 小型ガス化発電またはCHPユニットを同じEV充電系統に統合する方式（独立した熱供給設備とは異なる）；規模・初期投資・冬期／夜間／停電時の運用モデルの試算  
...
- 土地所有者との提携契約(契約書ひな形)  
- 太陽光・バイオマス発電・EV充電設備、データセンターハードウェア、IT機器の業者選定；蓄電池業者はフィージビリティスタディ確認後に検討  
- 主要な助成金申請の提出  
- 最初の2〜3名のパートタイム職員の採用  
**第2段階の資金目標**  
...
- **エネルギー**: 個人所有の屋根置き太陽光発電＋バイオマス発電装置（森林間伐材燃料）＋EV充電ステーション（初期2〜4台、需要に応じて拡張）；蓄電池はフィージビリティスタディで要否を確認  
