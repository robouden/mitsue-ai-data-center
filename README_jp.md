<p align="right">バージョン: v2.0 &nbsp;|&nbsp; 最終更新: 2026-05-18</p>
...
御杖プロジェクトは、閉校となった御杖小学校とその周辺の森林景観を、農村再生の統合的なモデルとして再活用するための非営利イニシアチブです。本プロジェクトは、在来種の森林再生、太陽光・蓄電池によるEV充電と地域エネルギーレジリエンス、小規模なコミュニティ所有のデータセンターという3つの相互補完的な活動を、単一の調整組織のもとに統合します。
...
**ビジョン（2050年）。** 御杖村は農村再生の自立したモデルとなる。再生した在来種の森林、太陽光・蓄電池によるEV充電と地域エネルギーレジリエンス、小規模なコミュニティ所有のデータセンターが一体となって、村の経済・生態系・デジタルの未来を支える。このモデルはオープンに文書化され、それを応用したいと願うすべてのコミュニティが自由に利用できる。
...
太陽光発電と蓄電池によるEV充電インフラと停電レジリエンス。出力は地域消費（村のEV充電・データセンター稼働・停電時のバックアップ電源）を想定し、経済的に適切な場合はFIT/FIPによる系統売電も行う。

太陽光＋蓄電池＋EV充電システムは、データセンターへの24時間安定電力供給とEV普及対応を同時に実現します。蓄電池は停電時の地域バックアップ電源としても機能し、農村部の老朽化した配電線に対するレジリエンスを提供します。
