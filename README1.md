...
The first three years are organised into five phases, each gated by an explicit funding checkpoint. The full phase logic, including hold/descope branches and the funding-source map, is documented in [mitsue_phases_funding_flowchart.md.](mitsue_phases_funding_flowchart.md "mitsue_phases_funding_flowchart.md")  
flowchart LR  
...
A more detailed plan, including phase-by-phase deliverables, ROI framework, and risk register, is in [mitsue_implementation_plan.md.](mitsue_implementation_plan.md "mitsue_implementation_plan.md")  
...
A live working list is maintained in [mitsue_todo.xlsx (PDF copies in English and Japanese available in the repository).](mitsue_todo.xlsx "mitsue_todo.xlsx")  
...
**Founding Documents**  
- [mitsue_founding_charter.md — bilingual (EN/JP) founding charter](mitsue_founding_charter.md "mitsue_founding_charter.md")  
- [mitsue_founder_agreement_template.md — founder alignment template](mitsue_founder_agreement_template.md "mitsue_founder_agreement_template.md")  
