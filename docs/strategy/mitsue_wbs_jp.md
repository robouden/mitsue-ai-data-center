...
<p style="font-style:italic; color:#666; margin:2mm 0 8mm;">バイオマスエネルギーとAI — 作業分解構造（WBS）</p>
...
```
0.0  バイオマスエネルギーとAI（フェーズ0〜3）                      ¥220.0M
 │
 ...
 │    ├── 3.5  通信環境調査
 │    ├── 3.6  運営基盤整備
 │    └── 3.7  村再エネ計画との整合・交付金事業計画の共同策定（官民連携）
 │
...
| 項目 | 内容 |
|------|------|
| スコープ | 杉間伐材を燃料とするバイオマスCHPサイジング（主たる供給源）― ベースロード電力＋熱、燃料供給ロジスティクス；補完的な学校敷地の太陽光発電ポテンシャル；蓄電池サイジング；系統接続オプション；FIT/FIP適格性評価；EV充電負荷モデリング；停電時レジリエンスシナリオ |
| 担当者 | テクノロジー担当理事 |
| 予算 | ¥1.5M（¥2〜4Mレンジの下限） |
| 成果物 | エネルギー調査報告書；バイオマスCHPサイジング・運用モデル；太陽光発電量モデル；蓄電池サイジング推奨書；FIT/FIP適格性確認書 |
...
| 項目 | 内容 |
|------|------|
| スコープ | アドバイザリーボードの正式化（Ray Ozzieほかから承諾書取得）；バイリンガルウェブサイト公開；資金調達パイプライン文書化；補助金カレンダー設定 |
| 担当者 | 代表理事 |
| 予算 | ¥0.8M |
| 成果物 | 署名済みアドバイザリーボード承諾書；ウェブサイト公開；フェーズ2補助金申請カレンダー |
| 受入基準 | 理事会によるウェブサイト確認；アドバイザリーボードの書面確認 |

#### 3.7 村再エネ計画との整合・交付金事業計画の共同策定（官民連携） — ¥0（PM管理費に含む）

| 項目 | 内容 |
|------|------|
| スコープ | プロジェクトの成果物を村の公式再エネ計画（御杖村再エネ導入最大化計画）の基本方針・指標（「村内1拠点」目標を含む）に対応づける；村の複数年度 地域脱炭素移行・再エネ推進交付金 事業計画を共同策定；本プロジェクトを官民連携の運営パートナーとして位置付ける。フェーズ2の補助金申請（4.7参照）へ継続。 |
| 担当者 | 代表理事＋日本人共同創業者 |
| 予算 | ¥0 — 1.0 PM・ガバナンス／4.7 補助金申請に吸収（新規BAC計上なし） |
| 成果物 | 成果物−計画 対応表；村と共同で準備した交付金事業計画への入力；官民連携の役割確認 |
| 受入基準 | 村が本プロジェクトの交付金申請における運営パートナー役を確認 |

> **注：** 村は環境省資金ラダーの第1段（計画づくり支援事業→再エネ計画、2025年1月）を完了。本タスクは第2段（交付金、太陽光・蓄電池・EV・自営線の補助率2/3〜3/4、村経由）を前進させる。`mitsue_village_re_plan_alignment_jp.md` 参照。
...
| 項目 | 内容 |
|------|------|
| スコープ | 主要補助金の申請書作成・提出：地方創生関係交付金、林野庁補助金、NEDO、METI、奈良県、日本財団、地球環境基金；**村の地域脱炭素移行・再エネ推進交付金 事業計画への協力（太陽光・蓄電池・EV・自営線の補助率2/3〜3/4、村の官民連携経由 — タスク3.7の継続）** |
| 担当者 | 財務・運営担当理事（専門行政書士サポート） |
| 予算 | ¥2.0M（申請4〜6件；行政書士費用¥20万〜50万/件） |
| 成果物 | 最低4件の補助金申請提出；フェーズ2末時点で申請中の補助金¥3,000万以上；村の交付金事業計画への入力提供 |
