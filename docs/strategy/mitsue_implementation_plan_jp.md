...
|-|-|-|-|  
| **段階** | **期間** | **主眼** | **概算予算** |   
| 0. 準備期 | 2026年4月〜10月 | 地域の信頼構築、創設チーム形成、基本構造 | ¥0〜50万円(自己資金) |   
| 1. 基盤期 | 2026年10月〜2027年5月 | 法人設立、フィージビリティスタディ | ¥300万〜800万円 |   
| 2. 試行設計期 | 2027年5月〜2028年5月 | 詳細設計、提携、許認可 | ¥1,500万〜3,000万円 |   
| 3. 試行構築期 | 2028年5月〜2029年11月 | 小規模初期段階の建設 | ¥1億2,000万〜2億9,000万円 |   
| 4. 運営・拡大期 | 2029年11月以降 | 運営、モニタリング、拡張 | 変動 |   

> **スケジュール状況（2026-07-03更新）** 上記の期間は**稼働中のOpenProjectガントチャート**（現行の正式スケジュール）を反映しています。当初の2026年4月起点の月次計画（P0=1〜3か月目、P1=4〜9か月目 等）より遅れています。フェーズ0の信頼構築と共同創設者の確定に想定以上の時間を要しているためです。月次相対の期間は継続性のため各セクション見出しに併記しています。正式な再ベースライン（EVMベースラインRev 2、2026年12月予定）でこのスケジュールをコスト基準へ反映します。それまでEVMのPMB月次曲線はRev 1のままです。**フェーズ1はゲート1通過後に正式開始します**（日本人共同創設者の口頭確約＋¥300万〜800万）。一部のフェーズ1法務・法人設立の準備は、調査目的のみでゲートに先行して進めています。

これらの数値は日本の農村部の現実を踏まえた控えめな見積もりですが、バイオマスCHP・太陽光・EV充電設備、蓄電池（フィージビリティスタディで判断）、光ファイバーの利用可能性、建物の状態によって実費は大きく変動いたします。  

**第0段階 ― 準備期(2026年4月〜10月・当初1〜3か月目)**  
...
**第1段階 ― 基盤期(2026年10月〜2027年5月・当初4〜9か月目)**  
...
**第2段階 ― 試行設計期(2027年5月〜2028年5月・当初10〜18か月目)**  
...
**第3段階 ― 試行構築期(2028年5月〜2029年11月・当初19〜30か月目)**  
...
- **建物**: 選定した第1段階の建物（有力候補は旧菅野小学校（体験交流館）。最終選定は第1段階で確定）の一棟を事務所と小規模サーバー室として改修  
...
> **村への早期効果について。** 25年という時間軸は森林再生の生態的な期間でございます。村への具体的な恩恵ははるかに早く現れまして、第0〜3段階を通じた年次別の効果(旧菅野小学校の活用、山林所有者への伐採収入、EV充電、停電レジリエンス、データセンターの地域雇用など)は、[`mitsue_village_government_onepager_jp.md`](mitsue_village_government_onepager_jp.md) の「5年以内に見える早期効果」表をご参照ください。

**第4段階 ― 運営・拡大期(2029年11月以降・当初31か月目以降)**  
...
- 来るEV時代に備えた充電インフラ整備  
- 旧菅野小学校（御杖体験交流館）を地域に根ざした施設として活用継続  
...
- **旧菅野小学校維持の負担**: 体験交流館は現在、年間¥300〜800万円の維持費を要する状態。活用は塩漬け資産から価値を生み出す  
...
**このROI根拠の活用方法**  
- **村役場向け**: 住民の定性的恩恵を最初に示し、続いてコスト代替効果(村外流出するエネルギー支出、塩漬け資産としての旧菅野小学校)を提示  
...
バイオマスエネルギーとAIの強みは、25年という長期視点にあります。1年目に急ぐ必要はありません。25年目が成功となるか失敗となるかを決定づける、信頼、体制、能力を、長く慎重に積み上げていく時間があるのです。  
**ゆっくりが滑らかに。滑らかが速さに。**  
