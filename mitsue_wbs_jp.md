...
| 項目 | 内容 |
|------|------|
| スコープ | 候補杉林の現地調査；間伐残材収量見積（バイオマス発電燃料としての利用量）；急峻地形からの輸送コスト分析；在来種森林再生計画；炭素固定量見積 |
| 担当者 | 林業・地域担当理事 |
...
| 項目 | 内容 |
|------|------|
| スコープ | 重要施設の12〜48時間停電バックアップに対応するリチウムイオン蓄電池；BMS（電池管理システム）；太陽光・系統との統合；安全認証 |
| 担当者 | テクノロジー担当理事 |
| 予算 | ¥12.0M |
...
| 項目 | 内容 |
|------|------|
| スコープ | 署名済み土地所有者契約に基づく杉5〜10ha伐採；材木は用材へ加工、残材は将来のバイオマス発電用燃料として備蓄；在来種植栽開始；林道・排水整備；J-Credit申請書類作成 |
| 担当者 | 林業・地域担当理事 |
| 予算 | ¥25.0M |
