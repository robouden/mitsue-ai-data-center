...
PROJECT_ID="3"
JSON_OUT="$SCRIPT_DIR/openproject_backup.json"
SQL_OUT="$SCRIPT_DIR/openproject_backup.sql"

echo "==> Exporting work packages to JSON..."
PAGE_SIZE=500
ALL="[]"
OFFSET=1
...
echo "    $TOTAL work packages saved to openproject_backup.json"
...
cd "$SCRIPT_DIR"
git add openproject_backup.json openproject_backup.sql
