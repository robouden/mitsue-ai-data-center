...
御杖くんプロジェクトは、**旧菅野小学校（御杖体験交流館）**（活用可能な地域の空き交流施設。拠点の有力候補で、最終選定は第1段階で確定）と、その上に広がる老齢化した杉林を、農村における自給自足の生きたモデルへと変えるものです。三つの要素が連携して機能します：
...
日本の農村活性化プロジェクトの多くは、外部補助金に恒久的に依存するか、土地や地域と結びつきのない用途を持ち込むかという失敗に陥ります。御杖くんプロジェクトは村自身の資源 ― 森、地域施設、そして人 ― を核として構築されており、最初の10年以内に財政的に自立できる設計になっています。
